...
const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      { text: 'עמוד סטטיסטיקות מלא — כל מספר ביומן שלך, חתוך לפי סשן, סטאפ ויום', on: true },
      { text: 'ללא ניתוח AI — העסקאות שלך לא מנותחות במסלול הזה', on: false },
      { text: 'ללא עמוד ה-AI Analytics וללא המאמן האישי', on: false },
    ],
  ...
  },
  {
    ...
    features: [
      { text: 'כאן המערכת מתחילה לנתח: תובנה יומית אישית, מעקב אחרי הרגלים, וזיהוי מה שחוזר על עצמו במסחר שלך', on: true },
...
const ROWS: Row[] = [
  ...
  { feat: 'עמוד סטטיסטיקות מלא',                             s: 'yes', p: 'yes', d: 'yes' },
  { feat: 'ניתוח AI של העסקאות (תובנה יומית + מעקב הרגלים)', s: 'no',  p: 'yes', d: 'yes' },
...
const FAQ: { q: string; a: React.ReactNode }[] = [
  {
    ...
    a: <>STARTER (49 <Nis />) הוא היומן במלואו: תיעוד עסקאות, מחברת, סטאפים, חוקים ועמוד סטטיסטיקות מלא על כל מה שרשמת. הוא לא כולל ניתוח — במסלול הזה המערכת לא מנתחת את העסקאות שלך בכלל. PRO (99 <Nis />) הוא הרגע שבו היא מתחילה: תובנה יומית אישית, מעקב אחרי הרגלים שחוזרים על עצמם, זיכרון דפוסים שנבנה עליך שבוע אחר שבוע, סימולטור תרחישים (&quot;מה היה קורה אם רק סחרתי בסשן NY?&quot; — נענה על עסקאות אמת), ודוח שבועי עם ארכיון מלא. ההפרש הוא 50 <Nis /> בחודש, והוא ההפרש בין יומן לבין יומן שמסתכל עליך בחזרה.</>,
  },
  {
