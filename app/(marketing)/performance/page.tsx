...
const METHOD = [
  'כל עסקה נרשמת אוטומטית ברגע הסגירה, כולל הקשר הביאס והסשן.',
        ...
        <div className="pf-foot-in">
          <div>
            ...
            <p className="pf-foot-p">
              ...
              השקעות או המלצה לביצוע פעולה. הביאס היומי הוא אחת מנקודות המבט של המערכת — יש
              להפעיל תמיד שיקול דעת עצמאי. השימוש באתר ובמערכת הוא באחריות המשתמש בלבד.
            </p>
          </div>
