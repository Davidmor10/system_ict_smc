...
const STEPS = [
  { n: '01', t: 'מתעד — שתי דקות', b: 'כניסה, סטופ, יעד, יציאה. הרווח, ה־R, הסשן והתוצאה מחושבים לבד — אף אחד מהם לא נשאל.' },
...
const TRUTHS = [
  {
    ...
    b: 'אחוז הצלחה על 3 עסקאות הוא לא אחוז הצלחה. המערכת לא מציגה טענה מתחת ל־8 עסקאות שנסגרו ולא קוראת לה מבוססת מתחת ל־15 — ותמיד אומרת לך על כמה עסקאות היא מדברת.',
  },
  {
